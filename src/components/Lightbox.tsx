    ...
    return (
        <div className={styles.lightboxOverlay} onClick={onClose}>
            ...
            <div className={styles.imageContainer} onClick={e => e.stopPropagation()}>
                ...
                {type === 'video' && (
                    <video controls src={src} className={styles.lightboxImage} style={{ transform: `scale(${scale})` }} />
                )}

                {type === 'document' && (
                    <iframe src={src} style={{ width: '80vw', height: '80vh', border: 'none', background: 'white' }} />
                )}
            </div>
        </div>
    );
