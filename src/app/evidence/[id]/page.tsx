...
import {
    ...
    faShareAlt, faShieldAlt, faCheckCircle, faClock,
    faArrowLeft, faBrain, faVrCardboard, faFingerprint,
                    ...
                    <div className={styles.mainColumn}>
                        ...
                        <div className="section">
                            ...
                            <div className={styles.evidenceList}>
                                {caseInfo.evidence.map((ev: any, i: number) => (
                        ...
                        <div className="section">
                            ...
                            <div className={styles.aiResults}>
                                {caseInfo.aiResults.map((r: any, i: number) => (
                    ...
                    <div className={styles.sideColumn}>
                        <div className="section">
                            ...
                            <div className={styles.timeline}>
                                {caseInfo.timeline.map((t: any, i: number) => (
